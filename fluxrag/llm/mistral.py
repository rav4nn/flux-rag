"""Mistral LLM client (Mistral Large and other models)."""
...
class MistralLLM(AbstractLLM):
    """Mistral models via the Mistral SDK."""

    def __init__(self, model: str = "mistral-large-latest", max_tokens: int = 1024) -> None:
